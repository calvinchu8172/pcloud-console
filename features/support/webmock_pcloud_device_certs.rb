Before '@webmock' do
  ...
  stub_request(:get, "http://#{ENV['PCLOUD_API_HOST']}/console/device_certs/53152101-d6fe-4cb7-afb7-64e0f905a4b6").with(
    query: hash_including({ certificate_serial: ENV['CERTIFICATE_SERIAL'] })
  ).to_return{ |request|
    @device_certs ||= []
  ...
  # Device Cert - Update
  stub_request(:put, "http://#{ENV['PCLOUD_API_HOST']}/console/device_certs/53152101-d6fe-4cb7-afb7-64e0f905a4b6").to_return{ |request|
    params = Rack::Utils.parse_nested_query(request.body)
    attributes = {
      serial: "53152101-d6fe-4cb7-afb7-64e0f905a4b6",
