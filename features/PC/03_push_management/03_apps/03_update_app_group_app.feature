Feature: Push Management - App Groups - Update App group App
  ...
  Scenario: [03_03_03_01]
    ...
    Given the super admin has already signed in
     ...
     When the super admin fills in "名稱" with "pcloud-ios-test-modify"
     When the super admin chooses "停用"
     When the super admin fills in "描述" with "Pcloud Alpha iOS 測試版 改"
     ...
     When the super admin presses "解析成憑證與私鑰"
      And presses "提交"
    Then the super admin should be at page - "/admin/push/app_groups/569e2004-6ad8-4681-81dd-8769d2ea9b0b/apps/17ac740b-5c0f-4b55-a90e-1d65ec499a46"
      And should see "名稱 pcloud-ios-test-modify"
      And should see "描述 Pcloud Alpha iOS 測試版 改"
      ...
      And should see "APP SNS Topic arn:aws:sns:us-east-1:567710019248:pcloud-push-alpha-17ac740b-5c0f-4b55-a90e-1d65ec499a46"
  ...
  Scenario: [03_03_03_02]
    ...
    Given the super admin has already signed in
     ...
     When the super admin fills in "名稱" with "pcloud-ios-modify"
     When the super admin chooses "停用"
     When the super admin fills in "描述" with "Pcloud Alpha iOS 改"
     ...
     When the super admin presses "解析成憑證與私鑰"
      And presses "提交"
     Then the super admin should be at page - "/admin/push/app_groups/569e2004-6ad8-4681-81dd-8769d2ea9b0b/apps/01dd8f4e-df4a-425b-9943-96069c0622aa"
      And should see "名稱 pcloud-ios-modify"
      And should see "描述 Pcloud Alpha iOS 改"
      And should see "狀態 停用"
  ...
  Scenario: [03_03_03_02]
    ...
    Given the super admin has already signed in
     ...
     When the super admin fills in "名稱" with "pcloud-android-modify"
     When the super admin chooses "停用"
     When the super admin fills in "描述" with "Pcloud Alpha Android 版 改"
     ...
     When the super admin fills in "API Key" with "AIzaSyBYazNIBst6TAEoqBvE2thFqQd6vFlLzII"
      And presses "提交"
     Then the super admin should be at page - "/admin/push/app_groups/569e2004-6ad8-4681-81dd-8769d2ea9b0b/apps/419b0e28-a418-4e79-8dda-72cafbf4b036"
      And should see "名稱 pcloud-android-modify"
      And should see "描述 Pcloud Alpha Android 版 改"
      And should see "狀態 停用"
      ...
      And should see "APP SNS Topic arn:aws:sns:us-east-1:567710019248:pcloud-push-alpha-419b0e28-a418-4e79-8dda-72cafbf4b036"
      And should see "建立時間 2017-07-18T06:52:47.031Z"
