  ...
  Scenario: [03_01_01]
    ...
    Given the super admin has already signed in
     ...
     Then the super admin should be at page - "/admin/push/app_groups"
      ...
      And should see "名稱" - "APP_GROUP_NAME2" on User List table Row "1"
      And should see "描述" - "APP_GROUP_DESCRIPTION2" on User List table Row "1"
      And should see "建立時間" - "2017-07-14T02:57:42.587Z" on User List table Row "1"
      And should see "更新時間" - "2017-07-18T01:48:29.158Z" on User List table Row "1"
      And should see "名稱" - "APP_GROUP_NAME1" on User List table Row "2"
      And should see "描述" - "APP_GROUP_DESCRIPTION1" on User List table Row "2"
